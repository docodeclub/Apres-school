export const labSessions = [
  {
    ...
    capacity: 8,
    days: ["Mon 8 Jun", "Tue 9 Jun", "Wed 10 Jun", "Thu 11 Jun", "Fri 12 Jun"],
    features: ["Snack included", "Homework space", "Flexible collection"],
  },
  {
    id: "lab-kings-after",
    ...
    capacity: 6,
    days: ["Mon 8 Jun", "Tue 9 Jun", "Wed 10 Jun", "Thu 11 Jun", "Fri 12 Jun"],
    features: ["Outdoor games", "Quiet tables", "Trusted collection"],
  },
  {
    ...
    capacity: 12,
    days: ["Mon 8 Jun", "Tue 9 Jun", "Wed 10 Jun", "Thu 11 Jun", "Fri 12 Jun"],
    features: ["Morning register", "Light breakfast", "School handover"],
  },
  {
    id: "lab-rowans-camp",
...
export const labPaymentOptions = [
  ...
  ["tax-free", "Tax-Free Childcare", "Record reference and reconcile against the parent account."],
  ["voucher", "Childcare voucher", "Reserve place and mark payment as awaiting voucher allocation."],
];
