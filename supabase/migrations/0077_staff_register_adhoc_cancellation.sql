-- Expose the booking source to authorised register users so staff-created
-- ad-hoc care can be identified and cancelled from the operational register.
...
comment on function public.staff_register_for_day(date, text, text) is
  'Authoritative operational register with care details and staff ad-hoc booking provenance.';
