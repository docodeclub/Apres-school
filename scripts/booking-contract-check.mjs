...
[
  ...
  ["parent booking displays five clear journey stages", bookingLabSource.includes('label: "Children"') && bookingLabSource.includes('label: "Care"') && bookingLabSource.includes('label: "Dates"') && bookingLabSource.includes('label: "Payment"') && bookingLabSource.includes('label: "Confirm"')],
