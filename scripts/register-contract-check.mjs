...
checks.forEach(([label, pattern]) => {
  const source = label.startsWith("client")
    ...
    : label.startsWith("compact register") || label.startsWith("pupil drawer") || label.startsWith("register selectors") || label.startsWith("register renders") || label.startsWith("register provides") || label.startsWith("register exposes") || label.startsWith("register disables") || label.startsWith("register shows") || label.startsWith("register previews") || label.startsWith("admin UI") || label.startsWith("staff form")
      ? platformSource
