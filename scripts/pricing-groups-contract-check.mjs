...
const checks = [
  ...
  [invoice.includes("APRES SCHOOL LIMITED") && invoice.includes("Care Sessions") && invoice.includes("Payment Complete"), "parent invoice follows the professional finance invoice hierarchy"],
